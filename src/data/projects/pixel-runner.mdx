...
name: Pixel Runner
type: side
image: /og-images/projects/pixel-runner.jpg
sourceCode: https://github.com/rojasmart/pixel-runner
preview: https://pixel-runner-five.vercel.app/
technologies:
  - React.js
  - Canvas API
  - Node.js
...
description: Pixel Runner is an action-packed side-scrolling game built with React and TypeScript, featuring fluid animations, parallax backgrounds, and engaging combat mechanics. Play as a brave bunny warrior slashing through flying bat enemies while navigating through a beautifully rendered forest environment.
---

# **Pixel Runner**

![Screenshot of the app](/og-images/projects/pixel-runner.jpg)
