...
name: Where on Earth?
type: side
image: /og-images/projects/where-on-earth.jpg
sourceCode: https://github.com/rojasmart/where-on-earth
preview: https://where-on-earth.vercel.app/
technologies:
  - React.js
  - Typescript
  - Three.js
  ...
  - React Three Fiber
  - React Three Drei
description: A geography quiz application that uses a 3D globe to challenge users with geography-based questions about countries and locations around the world.
---

# Where on Earth?

![Portfolio Preview](/og-images/projects/where-on-earth.jpg)
